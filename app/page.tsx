...
import { sendURLForEmbedding } from './sendURLForScrapping';
...
export default function Home() {
  ...
  return (<>
    <Toaster />
    <main className="flex min-h-screen flex-col items-center justify-center p-24 overflow-x-clip">
      ...
      <nav className="fixed top-0 left-0 w-100% p-5 w-full
      "><h2>ChatMe</h2></nav>
      <form action={sendURLForEmbedding}>
        <label className=' pl-5 pr-5'>Enter `URL` to chat with</label>
        <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:w-[95vw] md:max-w-md">
