    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center justify-center p-24 ">
                ...
                <section className='min-h-[60vh] border-r-2 border-slate-100 border-r-slate-200 rounded-md min-w-[55vw]'>

                </section>
                <section className='flex mt-5 p-2 justify-between max-h-10 md:max-h-15 lg:max-h-15 bg-slate-100 rounded-md min-w-[55vw]'>
                    <input
                        ref={inputRef}
